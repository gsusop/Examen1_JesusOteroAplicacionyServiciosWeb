...
namespace ITM_VENTA_DE_CARROS.Clases
{
    public class clsCliente
    {
        private ITM_VentasEntities ITM_Ventas = new ITM_VentasEntities(); // Objeto de la base de datos permite manipular el CRUD de los objetos generados
        ...
        {
            Cliente clt = Consultar(cliente.Documento);
            if (clt == null) 
            {
        ...
        {
            Cliente clt = ITM_Ventas.Clientes.FirstOrDefault(e => e.Documento == Documento);//consulta un cliente por su documento
            return clt;
        }
